...
//console.info('testruns')
//run(createProgram('109,1,204,-1,1001,100,1,100,1008,100,16,101,1006,101,0,99'), 1)
//run(createProgram('1102,34915192,34915192,7,4,7,99,0'), 1)
//run(createProgram('104,1125899906842624,99'), 1)

console.info(run(createProgram(), 1))
console.info(run(createProgram(), 2))
